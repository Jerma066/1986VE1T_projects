...
//-------------------------------------------------------------------------------------------------------
//Функции для отображения одного символа на экране размером 6х8 пикселей (6 - ширина, 8 - высота)
...
void LCD_PutSymbol (uint8_t Symbol, uint8_t Address, int8_t Page)
{
...
{
//используется страничное деление экрана!
	uint32_t LenWord=0, Length=0, PositionForInsert=0, Temp, ValNumOfChar;
	uint8_t  CharVal[33];
	char* ms, NewStr[21];
